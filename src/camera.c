...
/*   Updated: 2026/01/22 18:08:55 by pberne           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_camera_rotate(t_data *d)
{
	...
	rotx = d->input.mouse_delta.y * CAM_ROTATION_SPEED * d->deltatime;
	roty = d->input.mouse_delta.x * CAM_ROTATION_SPEED * d->deltatime;
