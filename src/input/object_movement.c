...
/*   Updated: 2026/02/26 15:21:09 by pberne           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	object->object.as_triangle.points.a = ft_v3f_add(object->object.as_triangle.points.a, movement);
	object->object.as_triangle.points.b = ft_v3f_add(object->object.as_triangle.points.b, movement);
	object->object.as_triangle.points.c = ft_v3f_add(object->object.as_triangle.points.c, movement);
		...
		int *dirty_bvh)
{
	if (object->type == object_type_triangle)
		...
		object->object.as_plane.position
			= ft_v3f_add(object->object.as_plane.position, movement);
	else
	{
		...
		int *dirty_bvh)
{
	if (object->type == object_type_sphere)
	{
		object->object.as_sphere.position
			= ft_v3f_add(object->object.as_sphere.position, movement);
		object->bounds = ft_get_sphere_bounds(object->object.as_sphere);
	}
	else if (object->type == object_type_cylinder)
	{
		object->object.as_cylinder.position
			= ft_v3f_add(object->object.as_cylinder.position, movement);
	...
	else if (object->type == object_type_quad)
	{
		object->object.as_quad.position
			= ft_v3f_add(object->object.as_quad.position, movement);
