...
/*   Updated: 2026/03/07 16:24:48 by pberne           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_bvh_stack_item
{
	int					id;
	float				distance;
}						t_bvh_stack_item;
...
{
	t_bvh_stack_item	stack[32];
	int					stack_ptr;
	double				t;
	double				best_dist;
	int					best_index;
	t_bvh_stack_item	node_idx;
	t_bvh_node			*node;
	int					l_idx;
	int					r_idx;
	t_v3f				dist;
	t_aabb_4x			aabb_c;
	t_bvh_stack_item	next;
}						t_bvh_context;

typedef struct s_collapse_context
{
	t_bvh_node			*node;
	int					binary_children[2];
	int					count;
	t_bvh_node			*child;
	t_bounds			child_bounds[4];
	int					i;
}						t_collapse_context;

typedef struct s_prune_context
{
	int					*map;
	int					active_count;
	int					i;
