...
/*   Updated: 2026/04/19 23:25:10 by pberne           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_rt_parser_iter
{
	size_t				objects_len;
	size_t				objects_cap;
...
void					ft_add_object(t_rt_parser_iter *data,
							t_parsed_object object);
t_io_res				ft_rt_iter_next(t_rt_parser_iter *self,
							t_parsed_object *o);
